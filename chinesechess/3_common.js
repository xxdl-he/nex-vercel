...
com.stype = {
    stype1: {
        ...
        pointStartY: 19,
        page: "stype_1"
    }, stype2: {width: 530, height: 567, spaceX: 57, spaceY: 57, pointStartX: -2, pointStartY: 0, page: "stype_2"}
}
com.get = function (id) {
...
window.onload = function () {
    ...
    com.get("stypeBn").addEventListener("click", function (e) {
        ...
        if (stype == "stype1") stype = "stype2"; else if (stype == "stype2") stype = "stype1";
        com.init(stype);
        com.show();
        play.depth = 4;
        play.init();
    ...
    com.getData("3_gambit.all.js", function (data) {
        com.gambit = data.split(" ");
        AI.historyBill = com.gambit;
    })
    com.getData("3_store.js", function (data) {
        com.store = data.split(" ");
    })
}
com.loadImages = function (stype) {
    com.bgImg = new Image();
    com.bgImg.src = "3/" + stype + "/bg.png";
    com.dotImg = new Image();
    com.dotImg.src = "3/" + stype + "/dot.png";
    for (var i in com.args) {
        com[i] = {};
        com[i].img = new Image();
        com[i].img.src = "3/" + stype + "/" + com.args[i].img + ".png";
    }
    com.paneImg = new Image();
    com.paneImg.src = "3/" + stype + "/r_box.png";
    document.getElementsByTagName("body")[0].style.background = "url(3/" + stype + "/bg.jpg)";
}
com.show = function () {
